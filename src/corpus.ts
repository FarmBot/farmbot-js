...
export type ScopeDeclarationBodyItem = VariableDeclaration
...
export type InternalFarmEventBodyItem = VariableDeclaration;
...
export type InternalRegimenBodyItem = VariableDeclaration
  | ParameterDeclaration;
...
export type PlantStage = "planned"
  ...
  | "harvested"
  | "sprouted";
export type AllowedGroupTypes = "Tool"
  | "GenericPointer"
  | "Plant"
  | "ToolSlot";
