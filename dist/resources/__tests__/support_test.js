...
describe("resolveOrReject", function () {
    var resolve = jest.fn();
    var reject = jest.fn();
    var ok = { kind: "rpc_ok", args: { label: "OK" } };
    var no = { kind: "rpc_error", args: { label: "NO" } };
    it("resolves", function () { return __awaiter(_this, void 0, void 0, function () {
        var fn;
    ...
    it("rejects", function () { return __awaiter(_this, void 0, void 0, function () {
        var fn;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
