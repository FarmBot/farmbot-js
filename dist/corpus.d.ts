...
export interface MoveAbsolute {
    kind: "move_absolute";
    args: {
        location: Coordinate | Identifier | Point | PointGroup | Tool;
        speed: number;
        offset: Coordinate;
    };
    comment?: string | undefined;
...
export interface VariableDeclaration {
    ...
    args: {
        label: string;
        data_value: Coordinate | Identifier | Point | PointGroup | Tool;
    };
    comment?: string | undefined;
    body?: undefined;
}
