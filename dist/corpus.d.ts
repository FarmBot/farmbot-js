...
export interface Sequence {
    ...
    args: {
        version: number;
        locals: ScopeDeclaration | Nothing;
    };
    comment?: string | undefined;
...
export declare type ScopeDeclarationBodyItem = ParameterDeclaration;
...
export declare type LegalArgString = "_else" | "_then" | "axis" | "channel_name" | "data_type" | "label" | "lhs" | "locals" | "location" | "message" | "message_type" | "milliseconds" | "offset" | "op" | "package" | "pin_mode" | "pin_number" | "pin_value" | "pointer_id" | "pointer_type" | "radius" | "rhs" | "sequence_id" | "speed" | "tool_id" | "url" | "value" | "version" | "x" | "y" | "z";
export declare type LegalKindString = "_if" | "calibrate" | "channel" | "check_updates" | "config_update" | "coordinate" | "emergency_lock" | "emergency_unlock" | "execute" | "execute_script" | "explanation" | "factory_reset" | "find_home" | "home" | "identifier" | "install_farmware" | "install_first_party_farmware" | "move_absolute" | "move_relative" | "nothing" | "pair" | "parameter_declaration" | "point" | "power_off" | "read_pin" | "read_status" | "reboot" | "register_gpio" | "remove_farmware" | "rpc_error" | "rpc_ok" | "rpc_request" | "scope_declaration" | "send_message" | "sequence" | "set_servo_angle" | "set_user_env" | "sync" | "take_photo" | "toggle_pin" | "tool" | "unregister_gpio" | "update_farmware" | "wait" | "write_pin" | "zero";
