...
export interface MoveAbsolute {
    kind: "move_absolute";
    args: {
        location: Coordinate | EveryLocation | Identifier | Point | Tool;
        speed: number;
        offset: Coordinate;
    };
    comment?: string | undefined;
...
export interface VariableDeclaration {
    ...
    args: {
        label: string;
        data_value: Coordinate | EveryLocation | Identifier | Point | Tool;
    };
    comment?: string | undefined;
    body?: undefined;
}
...
export interface EveryLocation {
    kind: "every_location";
    args: {
        pointer_type: string;
    };
